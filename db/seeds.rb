...
l4 = Location.create(name: "Ground", description: "The ground under bluberry, against the garage", image_url: "https://drive.google.com/uc?export=view&id=1UZENKkwkSjt7WDLhJqKSRaKqwepm6b_6")
...
l7 = Location.create(name: "Ground", description: "The ground between the bench and peach tree, by the fence", image_url: "https://drive.google.com/uc?export=view&id=1_6JD5WBtlQ6Uy9Ku9HX_SHZBZR8-aa6M")
l8 = Location.create(name: "Ground", description: "The ground around the fountain", image_url: "https://drive.google.com/uc?export=view&id=1-p0fTeysMEN4ZjsanKiW7F1ISmHxsiwM")
l9 = Location.create(name: "Ground", description: "The ground by the fence with the bell", image_url: "https://drive.google.com/uc?export=view&id=1Odl9PjSTJ4_6k9aVbtEoO34g2yCDFS2z")
l10 = Location.create(name: "Ground", description: "The ground by the arch on the side yard", image_url: "https://drive.google.com/uc?export=view&id=1MaTLcCe8yRSR-iBnZdgO0frOZM0JLkj9")
l11 = Location.create(name: "Ground", description: "The ground on the left from the steps by the garage", image_url: "https://drive.google.com/uc?export=view&id=1WTiEar56pPgcqAOZAbrndM-CHWehAXVZ")
l12 = Location.create(name: "Ground", description: "The ground on the right from the steps by the garage", image_url: "https://drive.google.com/uc?export=view&id=1355aV-XB2HsugTlWbecvB4SzZdpMIzaA")
...
l16 = Location.create(name: "Ground", description: "The ground under the raspberry", image_url: "https://drive.google.com/uc?export=view&id=1INsn5xogtVDra0kMwJs9IjAMUo2iFhF7")
l17 = Location.create(name: "Ground", description: "The ground at the corner of side yard, under the porch", image_url: "https://drive.google.com/uc?export=view&id=1W_RQW54paSSWbi4XbI4Bq_OHEgHKtyn1")
